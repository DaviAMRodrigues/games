...
image.src = './Tireoide/img/mapatireoide.png'

const foregroundImage = new Image()
foregroundImage.src = './Tireoide/img/tireoide.jpg'

const playerDownImage = new Image()
playerDownImage.src = './Tireoide/img/player.png'

const playerUpImage = new Image()
playerUpImage.src = './Tireoide/img/player.png'

const playerLeftImage = new Image()
playerLeftImage.src = './Tireoide/img/player.png'

const playerRightImage = new Image()
playerRightImage.src = './Tireoide/img/player.png'
